...
class Stationary:
    ...
    def __init__(self, title="Нарисуйте что-нибудь"):
        self.title = title
...
class Pen(Stationary):
    def draw(self):
        print(f'Начнем рисовать ручкой {self.title}')


class Pencil(Stationary):
    def draw(self):
        print(f'Начнем рисовать карандашом {self.title}')


class Marker(Stationary):
    def draw(self):
        print(f'Начнем рисовать маркером {self.title}')
